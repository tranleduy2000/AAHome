package com.example.tranleduy.aahome.custom_view;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                else if (slideListener != null && !isSliderOpen())
                    slideListener.onSlide(Direction.UP);
                break;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (distance * multiplier > height - barHeight)
